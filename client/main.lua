...
AddEventHandler('persistent-vehicles/forget-vehicle', function (entity)
	...
	TriggerServerEvent('VIVS_Locking:DeletePlates', NetworkGetNetworkIdFromEntity(entity), plate) ----------------------------- Remove Keys
end)
...
AddEventHandler('persistent-vehicles/spawn-vehicles', function (datas)
	...
	TriggerServerEvent('VIVS_Locking:NewNetIDs', updatedNetIds) -------------------------- Give Keys
end)
